    ...
    <div className="playlist-update">
      ...
      <div className="playlist-update-container">
        <section className="playlist-update-container-img">
          {playlistImg ? (
            <img
              className="playlist-update-container-img-content"
              src={playlistImg}
              alt="Image de votre playlist"
            />
          ) : (
            <img
              className="playlist-update-container-img-content"
              src={imgDefault}
              alt="Image par défaut d'une playlist"
            />
          )}
          <p>Changer l'image</p>
          <input
        ...
        <section className="playlist-update-container-info">
          ...
          {showTooLongName && (
            <p className="too_long">
              Le nom doit faire 30 caractères au maximum
            </p>
          )}
          ...
          {showTooLongDesc && (
            <p className="too_long">
              Votre description doit faire 100 caractères au maximum
            </p>
          )}
        </section>
      </div>
      ...
      <section className="playlist-update-songs">
        <button onClick={toggleState} className="playlist-update-songs-button">
          <img
            ...
            ref={songArrow}
          />
          <p className="playlist-update-songs-button-label">
        ...
        {toggle && (
          <div className="playlist-update-songs-list">
            <section className="playlist-update-songs-list-tracks">
              <p className="playlist-update-songs-list-tracks-title">
            ...
            <section className="playlist-update-songs-list-search">
              <p className="playlist-update-songs-list-search-title">
                Ajouter une musique
              </p>
              <hr />
              <input
      ...
      {showVolume && (
        <Volume musicVolume={musicVolume} setMusicVolume={setMusicVolume} />
      )}
      ...
      {showNotification && 
        showTooLongNotification && (
          <Notification setShowNotification={setShowNotification}>
            Votre playlist doit contenir au minimum 10 musiques pour être
            enregistrée.
          </Notification>
      )}
    </div>
